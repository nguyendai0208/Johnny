...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        //Font
        self.labelFont = [UIFont fontWithName:[SettingView sharedCache].fontName size:kLabelFontSize];
		//self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
        self.detailsLabelFont = [UIFont fontWithName:[SettingView sharedCache].fontName size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
